            ...
            <div className="flex items-center">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900 flex items-center">
                  ...
                  Prayer Moderator Schedule
                </h1>
                <p className="text-gray-600 mt-1">Monday and Saturday prayer session moderators</p>
              </div>
            </div>
          </div>
        </div>
            ...
            {Object.entries(groupedSchedules).map(([dayType, daySchedules]) => (
              <div key={dayType} className="mb-8">
                <h2 className="text-xl font-semibold text-gray-900 mb-4 flex items-center">
                  <Users className={`h-5 w-5 mr-2 ${dayType === 'MONDAY' ? 'text-blue-600' : 'text-green-600'}`} />
                  ...
                  <div className="space-y-3">
                    {daySchedules.map((schedule) => (
                      ...
                      >
                        <div className="flex items-center justify-between">
                          <div>
                            <h3 className="font-medium text-gray-900">{schedule.user.fullName}</h3>
            ...
            {filteredSchedules.length === 0 && (
              <div className="text-center py-12">
                ...
                <p className="text-gray-600 mb-4">
                  Prayer moderator schedules will appear here once they are generated by an administrator.
                </p>
              </div>
            )}
          </div>
